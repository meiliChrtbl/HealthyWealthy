...
<html lang="en">
<head>
    <title>Healthy Wealthy - Drink Recipe Edit Admin</title>
...
<?php
    ...
    if(isset($_POST['Edit']))
    {
        ...
        if(empty($nama)){
            mysqli_query($connection, "UPDATE drink SET NamaDrink ='$namadrink', Deskripsi='$desc', Bahan2='$bahan', Instruksi='$instruksi'
        ...
        if( ($ekstensifile == "JPG") or ($ekstensifile == "PNG")) {
            move_uploaded_file($file_tmp, 'images/'.$nama); //unggah file ke folder images
            mysqli_query($connection, "UPDATE drink SET NamaDrink='$namadrink', Deskripsi='$desc', Bahan2='$bahan' ,Instruksi='$instruksi', Photodrink='$nama'
            WHERE KodeDrink= '$kodedrink'");
            header("location:drink.php");
        }
    }
    ...
    $kodedrink = $_GET["ubah"];
    $editDrink = mysqli_query($connection, "SELECT * FROM drink WHERE KodeDrink = '$kodedrink'");
    $rowedit = mysqli_fetch_array($editDrink);
    ...
    <div class="col-sm-1"></div>
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid" style="background-color: #eeeeee;">
                <div class="container">
                    <h1 class="display-4">Drink Recipe Edit </h1>
                </div>
            </div>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['KodeDrink']?>" readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['NamaDrink']?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <img src="images/<?php echo $rowedit['PhotoDrink']?>"  style="width:220px; height:100px;">
