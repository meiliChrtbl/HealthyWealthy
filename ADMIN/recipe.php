...
<html lang="en">
<head>
    <title>Healthy Wealthy - Food Recipe Admin</title>
...
<?php
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(($ekstensifile == "JPG") or ($ekstensifile == "jpg") or ($ekstensifile == "png") or ($ekstensifile == "PNG"))
        {
            ...
            mysqli_query($connection, "INSERT INTO recipe value ('$koderecipe', '$namarecipe', '$desc', '$bahan' , '$instruksi', '$nama')");
            header("location:recipe.php");
        }
    }

    $dataresep = mysqli_query($connection, "SELECT * FROM recipe");
    ...
    <div class="col-sm-1"></div>
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid" style="background-color: #eeeeee;">
                <div class="container">
                    <h1 class="display-4">Food Recipe Input </h1>
                </div>
            </div>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                placeholder="Kode Resep" maxlength="4">
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid" style="background-color: #eeeeee;">
            <div class="container">
                <h1 class="display-4">Food Recipe List</h1>
            </div>
        </div>
