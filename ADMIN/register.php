...
<?php
    ...
    if(isset($_POST['Regis']))
    {
        ...
        if ($_POST["pass"] === $_POST["repeat"]) {
            mysqli_query($connection, "INSERT INTO admin value ('$first_name', '$last_name', '$email_user', '$password' , '$repeat_pass')");
                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" class="user" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="repeat_pass" placeholder="Repeat Password" name="repeat">
                                    </div>
                                </div>

                                <input type="submit" name="Regis" class="btn btn-primary btn-user btn-block" value="Register Account">
