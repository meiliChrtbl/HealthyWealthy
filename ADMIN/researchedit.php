...
<html lang="en">
<head>
    <title>Healthy Wealthy - Research Edit Admin</title>
...
<?php
    ...
    if(isset($_POST['Edit']))
    {
        ...
        if(empty($nama)){
            mysqli_query($connection, "UPDATE research SET Judul ='$judul', Kategori ='$kat', Tanggal ='$tanggal', Penerbit ='$penerbit', URL = '$url'
            WHERE Kode = '$kode'");
    ...
    $kode = $_GET["ubah"];
    $edit = mysqli_query($connection, "SELECT * FROM research WHERE Kode = '$kode'");
    ...
    <div class="col-sm-1"></div>
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid" style="background-color: #eeeeee;">
                <div class="container">
                    <h1 class="display-4">Research Edit </h1>
                </div>
            </div>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['Kategori']?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                value="<?php echo $rowedit['Tanggal']?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <img src="images/<?php echo $rowedit['Foto']?>"  style="width:220px; height:100px;">
